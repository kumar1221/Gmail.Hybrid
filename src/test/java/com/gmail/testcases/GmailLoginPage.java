...
import com.gmail.utilities.BrowserUtilities;
import com.relevantcodes.extentreports.LogStatus;

public class GmailLoginPage extends BrowserUtilities {
	...
	public void TestHome() throws IOException {
		...
		gmailPageFactoryLogin.gmailLogout();
		logger.log(LogStatus.PASS, "Gmail Logout Successful");
	}
}
